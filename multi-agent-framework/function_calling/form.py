...
REGIONS = json.loads("[]")
# MOUSE_LINES = json.load(open(join(dirname(__file__), 'mouse_lines.json')))
MOUSE_LINES = json.loads("[]")
def get_form_functions():
    ...
    },
    {
        ...
        "function": {
            "name": "set_mouse_line",
            "description": "Set line or mouse line for neuron filtering.",
            "parameters": {
                "type": "object",
                "properties": {
                    "mouse_line": {
